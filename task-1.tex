...
\def\NameB{Steffan Wolter}		%Hier den Name des 2. Gruppenmitglieds eintragen
\def\MatB{10037044}			%Hier die Matrikelnummer des 2. Gruppenmitglieds eintragen
\def\NameC{Ümit Akbas}				%Name 3. Gruppenmitglied
\def\MatC{2295890}					%Matrikelnummer 3. Gruppenmitglied
...
\section*{Aufgabe 1}
\begin{enumerate}[a)]
	\item $1 \ll 2 \ll ... \ll 6$ % inline mathmode
	\begin{enumerate}[1.]
